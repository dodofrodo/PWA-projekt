...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Raspored radnika</h1>
            </div>

            
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Raspored radnika</h6>
                </div>
                <div class="card-body">
                    <div class="sb-entity-selector" style="max-width:300px;">
                        <form action="employees-schedule.php" method="POST">
                            <div class="form-group">
                                ...
                                <button type="submit" name="show_schedule_sbmt" class="btn btn-primary">Prikaži raspored</button>
                            </div>
                        </form>
                    </div>
                    
                    <div class="alert alert-info">
                        Podešavajte svoj raspored ovdje. Samo odaberite početno i završno vrijeme kako bi napravili raspored za radnika.
                    </div>
                    ...
                    <div class="sb-content" style="min-height: 500px;">
                        ...
                        ?>
                                <form method="POST" action="employees-schedule.php">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" name="save_schedule_sbmt" class="btn btn-info">Spremi raspored</button>
                                    </div>
                                </form>
                        <?php
                            }
                                ...
                                {   
                                    ...
                                    ?>
                                        ...
                                        <script type="text/javascript">
                                            swal("Postavi raspored!","Uspješno ste postavili radnikov raspored!", "success").then((value) => {}); 
                                        </script>
