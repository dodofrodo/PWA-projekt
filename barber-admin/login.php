		...
		<div class="login">
			<form class="login-container validate-form" name="login-form" method="POST" action="login.php" onsubmit="return validateLogInForm()">
					...
					if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['signin-button']))
					{
						...
						else
						{
							...
							<div class="alert alert-danger">
								...
								<div class="messages">
									<div>Korisničko ime ili lozinka su neispravni!</div>
								</div>
							</div>
				...
				<div class="form-input">
					<span class="txt1">Korisničko ime</span>
					...
					<span class="invalid-feedback" id="required_username">Korisničko ime je obavezno!</span>
				</div>
				
				<!-- PASSWORD INPUT -->

				<div class="form-input">
					<span class="txt1">Lozinka</span>
					...
					<span class="invalid-feedback" id="required_password">Lozinka je obavezna!</span>
				</div>
				
				<!-- SIGN IN BUTTON -->

				<p>
					<button type="submit" name="signin-button" >Prijava</button>
				</p>
		...
		<footer class="sticky-footer bg-white">
			<div class="container my-auto">
		  		<div class="copyright text-center my-auto">
					<span>Copyright &copy; barbershop by Dorian Stojcevic</span>
		  		</div>
			</div>
	  	</footer>
		<!-- End of Footer -->
