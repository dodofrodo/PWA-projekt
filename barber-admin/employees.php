...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Radnici</h1>
            ...
            <?php
                    ...
                    ?>
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Radnici</h6>
                            </div>
                            <div class="card-body">
                                                ...
                                                foreach($rows_employees as $employee)
                                                {
                                                    ...
                                                    ?>
                                                        <ul class="list-inline m-0">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Promijeni">
                                                            ...
                                                            <li class="list-inline-item" data-toggle="tooltip" title="Izbriši">
                                                                    ...
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="exampleModalLabel">Izbriši radnika</h5>
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                ...
                                                                                <button type="button" data-id = "<?php echo $employee['employee_id']; ?>" class="btn btn-danger delete_employee_bttn">Izbriši</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                elseif($do == 'Add')
                {
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Dodaj radnika</h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="employees.php?do=Add">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_fname">Ime</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_fname']))?htmlspecialchars($_POST['employee_fname']):'' ?>" placeholder="Ime" name="employee_fname">
                                            <?php
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_lname">Prezime</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_lname']))?htmlspecialchars($_POST['employee_lname']):'' ?>" placeholder="Prezime" name="employee_lname">
                                            <?php
                                                if(isset($_POST['add_new_employee']))
                                                {
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="employee_phone">Broj mobitela</label>
                                            <input type="text" class="form-control" value="<?php echo (isset($_POST['employee_phone']))?htmlspecialchars($_POST['employee_phone']):'' ?>" placeholder="Broj mobitela" name="employee_phone">
                                            <?php
                                                if(isset($_POST['add_new_employee']))
                                                {
                                ...
                                <button type="submit" name="add_new_employee" class="btn btn-primary">Dodaj radnika</button>
                                    ...
                                    try
                                    {
                                        ...
                                        ?> 
                                            ...
                                            <script type="text/javascript">
                                                swal("Uspješno ste dodali novog radnika!").then((value) => 
                                                {
                ...
                elseif($do == 'Edit')
                {
                    ...
                    if($employee_id)
                    {
                        ...
                        if($count > 0)
                        {
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Uredi radnika</h6>
                                </div>
                                <div class="card-body">
                                    <form method="POST" action="employees.php?do=Edit&employee_id=<?php echo $employee_id; ?>">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_fname">Ime</label>
                                                    <input type="text" class="form-control" value="<?php echo $employee['first_name'] ?>" placeholder="Ime" name="employee_fname">
                                                    <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_lname">Prezime</label>
                                                    <input type="text" class="form-control" value="<?php echo $employee['last_name'] ?>" placeholder="Prezime" name="employee_lname">
                                                    <?php
                                                        if(isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if(empty(test_input($_POST['employee_lname'])))
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="employee_phone">Broj mobitela</label>
                                                    <input type="text" class="form-control" value="<?php echo $employee['phone_number'] ?>"  placeholder="Broj mobitela" name="employee_phone">
                                                    <?php
                                                        if(isset($_POST['edit_employee_sbmt']))
                                                        {
                                                            if(empty(test_input($_POST['employee_phone'])))
                                        ...
                                        if(isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_employee_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                ?> 
                                                    ...
                                                    <script type="text/javascript">
                                                        swal("Uspješno ste izbrisali radnika").then((value) => 
                                                        {
                                                            window.location.replace("employees.php");
                                                        });
                                                    </script>
