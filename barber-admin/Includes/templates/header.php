...
<html lang="en">
	...
	<body id="page-top">
  		...
  		<div id="wrapper">
			...
			<!-- Sidebar -->
			<ul class="navbar-nav sidebar sidebar-dark accordion" style="background-color: gray;" id="accordionSidebar">
		  		...
		  		<a class="sidebar-brand d-flex align-items-center justify-content-center" href="">
					...
					<div class="sidebar-brand-text mx-3">Frizerski</div>
		  		</a>
					  	...
					  	<ul class="navbar-nav ml-auto">
							<li class="nav-item">
		              			<a class="nav-link" href="../" target="_blank">
		                			...
		                			<span style="margin-left: 5px;">Posjeti stranicu</span>
		              			</a>
		          			</li>
